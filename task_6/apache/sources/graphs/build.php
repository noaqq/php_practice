...
function set_watermark(GdImage $image): void
{
    ...
    imagestring($stamp, 6, 2, 6, 'github.com/Tut1tam',
...
function plotting_graph(): GdImage
{
    ...
    $graph->SetBackgroundGradient('skyblue', 'silver');
    $data = substr_replace($data, '', 0, 1);
    $graph->yaxis->title->Set('Работники');
    $graph->title->Set('Работники библиотеки');
